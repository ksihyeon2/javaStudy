...
//		
		ActionListener listener = new ActionListener() { // 익명객체는 필드부분에 생성
			@Override
			public void actionPerformed(ActionEvent e) {
				if(btnInput.equals(e.getSource())) {    // 동작한 것을 건드렸는지 e가 확인
					JOptionPane.showMessageDialog(null, "입력버튼을 클릭하셨습니다.");
				} else if (btnUpdate.equals(e.getSource())) {
					JOptionPane.showMessageDialog(null, "수정버튼을 클릭하셨습니다.");
				} else if (btnSearch.equals(e.getSource())) {
					JOptionPane.showMessageDialog(null, "개별조회버튼을 클릭하셨습니다.");
				} else if (btnList.equals(e.getSource())) {
					JOptionPane.showMessageDialog(null, "전체조회버튼을 클릭하셨습니다.");
				} else if (btnDelete.equals(e.getSource())) {
					JOptionPane.showMessageDialog(null, "삭제버튼을 클릭하셨습니다.");
...
//		==> 간단하게 사용할때만 이렇게 사용하지만 잘 사용하지 않음
//		
	}
}
